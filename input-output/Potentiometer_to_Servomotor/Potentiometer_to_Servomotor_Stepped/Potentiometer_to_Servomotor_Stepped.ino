...
void loop() {
  ...
  int stepMultiplier = map(potVal, 0, 1023, 0, STEP_DIVISIONS);
  int stepSize = MAX_DEGREES / STEP_DIVISIONS;
  myServo.write(stepSize * stepMultiplier);
